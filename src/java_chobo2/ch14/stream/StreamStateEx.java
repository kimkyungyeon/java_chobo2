...
public class StreamStateEx {
	public static void main(String[] args) {
		...
		System.out.println("max totalScore Student " + optStd);
		System.out.println("min totalScore Student " + optStd2);
		
		Optional<Student> optStd3 = list.parallelStream().min((o1 , o2)-> o1.getTotalScore()-o2.getTotalScore());
		System.out.println("parallelStream min totalScore Student " + optStd3);
